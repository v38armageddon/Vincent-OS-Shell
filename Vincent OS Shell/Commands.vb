Module Commands
    Sub Commands()
        ...
        ElseIf cmd = "help" Then
            Console.Write("Bing Chrome.ShortVOS")
            Console.WriteLine()
            Console.Write("cd.ShVOS")
            Console.WriteLine()
            Console.Write("clear.ShVOS")
            Console.WriteLine()
            Console.Write("ls.ShVOS")
            Console.WriteLine()
            Console.Write("PS.CompVOS")
            Console.WriteLine()
            Console.Write("ver.ShVOS")
            Console.WriteLine()
        ElseIf cmd = "ver" Then
            Console.Write("Nom du Shell : Vincent OS Shell")
            Console.WriteLine()
            Console.Write("Version du Shell : 1.0.0.1")
            Console.WriteLine()
